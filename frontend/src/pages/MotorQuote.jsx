...
import {
  Car, ShieldCheck, CreditCard, ArrowRight, ArrowLeft, Check, User, Briefcase, Lock,
} from "lucide-react";
...
export default function MotorQuote() {
  ...
  const canSubmitStep1 =
    form.sum_insured > 0 && form.cover_type;
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10" data-testid="motor-quote-page">
        ...
        {STEPS.map((s, i) => {
          ...
          return (
            <React.Fragment key={s.key}>
                ...
                <div
                  className={`w-11 h-11 rounded-2xl flex items-center justify-center transition-colors ${
                    active
                      ...
                      : done
                      ? "bg-primary-50 text-primary-700 border border-primary/30"
              ...
              {i < STEPS.length - 1 && (
                <div
                  className={`flex-1 h-px mx-4 ${done ? "bg-primary" : "bg-gray-200"}`}
                />
              )}
            </React.Fragment>
          );
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm">
        {/* STEP 0 — Plan Selection + Personal Details combined into initial form */}
        {step === 0 && (
          <div className="animate-fade-in-up">
            <h2 className="font-display text-3xl font-semibold tracking-tight mb-2">
              Let's get your car insurance quote
            </h2>
            <p className="text-gray-500 mb-6">
              It takes under 3 minutes — and you get an instant 10% online rebate.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                <Label htmlFor="vreg">Vehicle Registration No.</Label>
                <Input
                  id="vreg"
              ...
              <div>
                <Label htmlFor="id-num">
                  {form.id_type === "nric" ? "NRIC Number" : "Passport Number"}
                </Label>
                <Input
                  id="id-num"
              ...
              <div className="md:col-span-2">
                <Label htmlFor="fname">Full Name (As Per NRIC/Passport)</Label>
                <Input
                  id="fname"
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <Button
                variant="outline"
                onClick={() => nav("/products/motor-easy")}
                className="rounded-full h-12 px-6"
                data-testid="motor-back-btn"
              >
        ...
        {step === 1 && product && (
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-500 mb-6">
              Tune your sum insured, No Claim Discount and optional add-ons.
            </p>
              ...
              {[
                {
                  key: "comprehensive",
                  title: "Comprehensive",
                  body: "Own damage, theft, fire + third-party.",
                  badge: "Recommended",
                },
                {
                  key: "third_party",
                  title: "Third Party",
                  body: "Legal minimum — third-party only.",
                },
              ].map((c) => (
                <button
                  key={c.key}
            ...
            <div className="grid md:grid-cols-2 gap-5 mb-6">
              <div>
                <Label htmlFor="si">Sum Insured (USD)</Label>
                <Input
                  id="si"
                  type="number"
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Based on your car's market value. Up to $500,000.
                </p>
              </div>
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  0% — 55%. You'll get a further 10% online rebate on top.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-8">
              ...
              <Button
                ...
                data-testid="motor-get-quote-btn"
        ...
        {step === 2 && quote && (
          <div className="animate-fade-in-up" data-testid="motor-quote-result">
            <h2 className="font-display text-3xl font-semibold tracking-tight mb-2">
              Your Motor Easy quote
            </h2>
            <p className="text-gray-500 mb-6">
              Review the breakdown and proceed to secure checkout.
            </p>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 capitalize">
                        {quote.input.cover_type.replace("_", " ")} · {form.vehicle_reg}
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex mt-8">
              <Button
                ...
                data-testid="motor-edit-quote-btn"
              >
                Edit quote
              </Button>
            </div>

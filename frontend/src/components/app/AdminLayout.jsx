...
import {
  ...
  GitBranch, MessageCircle, CheckSquare,
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex lux-bg">
      <aside
        ...
        className="w-72 lux-sidebar flex flex-col sticky top-0 h-screen"
      >
        <Link to="/admin" className="px-6 py-6 flex items-center border-b border-[rgba(222,178,94,0.12)]">
          <AfinityLogo size={30} />
        </Link>

    ...
    <div className="p-8" data-testid="admin-customers">
      <div className="mb-8 flex items-end justify-between">
        <div>
          ...
          <h1 className="font-display text-4xl font-semibold tracking-tight mt-1">Customers</h1>
        </div>
              ...
              >
                <td className="p-4">
                  <Link to={`/admin/customers/${u.id}`} className="flex items-center gap-3 hover:text-primary-700">
                    <div className="w-9 h-9 rounded-full bg-primary-50 flex items-center justify-center text-primary-800 font-semibold">
                ...
                <td className="p-4 text-sm font-medium">${Math.round(u.ltv || 0).toLocaleString()}</td>
                <td className="p-4">
